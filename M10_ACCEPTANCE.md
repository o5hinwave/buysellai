...
- Hosted cloud handoff: `.github/workflows/cloud-handoff.yml` defines the GitHub Actions `Cloud Handoff Check` for the cloud source of truth. It verifies the portable checkout, secret scan, Supabase schema static check, Supabase Edge Function source check, `AppStoreSite` build/test, and focused native iOS smoke tests without deploying Supabase or requiring App Store signing secrets.
