...
final class DesignAccessibilityTests: XCTestCase {
    ...
    func testSnapResultUsesNativeListAndStickyDecisionAction() throws {
        ...
        XCTAssertNotNil(source.range(of: #"Label("Looks right — add details".localized, systemImage: "checkmark.circle.fill")"#))
        ...
        let secondaryRange = try XCTUnwrap(source.range(of: #"secondaryActions(item: item)"#))
        let detailSectionRange = try XCTUnwrap(source.range(of: #"Section("What we found".localized) {"#, range: secondaryRange.upperBound..<source.endIndex))
        XCTAssertLessThan(secondaryRange.lowerBound, detailSectionRange.lowerBound)
    }
    ...
    func testHomePrimaryActionUsesAppleSimpleOneTwoThreeFrontDoor() throws {
        ...
        XCTAssertNotNil(home.range(of: "Color(uiColor: .separator).opacity(0.12)"))
        XCTAssertNotNil(home.range(of: "Color.black.opacity(0.06)"))
        XCTAssertNotNil(home.range(of: "private struct HomeStepRow: View"))
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 1, title: "Snap it""#))
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 2, title: "Answer tiny questions""#))
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 3, title: "Copy the post""#))
        ...
        XCTAssertNotNil(home.range(of: #"Text("Point. Shoot. Done.".localized)"#))
