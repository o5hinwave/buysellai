...
final class DesignAccessibilityTests: XCTestCase {
    ...
    func testFeedbackGeneratedContentAndSmallPickerSurfacesUseSharedNativeMaterialChrome() throws {
        ...
        XCTAssertNotNil(home.range(of: #"Label("No listings yet".localized, systemImage: "doc.text.fill")"#))
    ...
    func testHomePrimaryActionUsesAppleSimpleOneTwoThreeFrontDoor() throws {
        ...
        XCTAssertNotNil(home.range(of: #"HomeHeroTrailSymbol(systemImage: "message.fill", isPrimary: false)"#))
        ...
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 2, title: "Answer what you know", detail: "Skip anything you're unsure about.", systemImage: "message.fill")"#))
        ...
        XCTAssertNotNil(home.range(of: #"Image(systemName: "info.circle.fill")"#))
        XCTAssertNotNil(home.range(of: #"Label("No listings yet".localized, systemImage: "doc.text.fill")"#))
    ...
    func testTutorialGraphicEchoesHomeHeroVisualLanguage() throws {
        ...
        XCTAssertNotNil(graphicSource.range(of: #"Image(systemName: "message.fill")"#))
