...
final class DesignAccessibilityTests: XCTestCase {
    ...
    func testSnapResultStillWorkingHintAnnouncesAlertAndRetryAction() throws {
        ...
        XCTAssertNotNil(source.range(of: #"Label("Retry".localized, systemImage: AppSymbol.Action.retry)"#))
    ...
    func testItemQuestionsSheetUsesDynamicOneQuestionFlow() throws {
        ...
        XCTAssertNotNil(source.range(of: #"title: "Which one looks closest?""#))
        XCTAssertNotNil(source.range(of: #"detail: "Pick only if it matches what you can see. If not, skip it.""#))
        ...
        XCTAssertNotNil(source.range(of: #"return limitedQuestions"#))
    ...
    func testMarketplaceRowsAdaptForAccessibilityDynamicTypeAndPressFeedback() throws {
        ...
        XCTAssertNotNil(row.range(of: #"Text(comparison?.rowSignal(currencyCode: item.currencyCode) ?? estimate.comparisonSignals(for: item).rowLine)"#))
    ...
    func testListingExposesNativeCopyButtonsForUsefulDraftFields() throws {
        ...
        XCTAssertNotNil(copyFieldSource.range(of: #"Label("Copy".localized, systemImage: AppSymbol.Flow.copy)"#))
    ...
    func testListingSuccessActionsAreStickyAndOrderedAfterGenerationSucceeds() throws {
        ...
        let retakeRange = try XCTUnwrap(bottomSource.range(of: #"secondaryActionButton(title: "Wrong item — retake", systemImage: AppSymbol.Action.retakePhoto)"#))
        let regenerateButtonRange = try XCTUnwrap(bottomSource.range(of: #"secondaryActionButton(title: "Regenerate", systemImage: AppSymbol.Action.retry)"#))
