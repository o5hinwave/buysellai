...
final class DesignAccessibilityTests: XCTestCase {
    ...
    func testFeedbackGeneratedContentAndSmallPickerSurfacesUseSharedNativeMaterialChrome() throws {
        ...
        XCTAssertNotNil(home.range(of: #"Label("No listings yet".localized, systemImage: "tray.fill")"#))
    ...
    func testHomePrimaryActionUsesAppleSimpleOneTwoThreeFrontDoor() throws {
        ...
        XCTAssertNotNil(home.range(of: #".frame(maxWidth: .infinity, minHeight: 268)"#))
        XCTAssertNotNil(home.range(of: ".brandSymbol(.heroIcon)"))
        ...
        XCTAssertNotNil(home.range(of: #"Image(systemName: "camera.fill")"#))
        ...
        XCTAssertNotNil(home.range(of: #"HomeHeroTrailSymbol(systemImage: "camera.fill", isPrimary: true)"#))
        XCTAssertNotNil(home.range(of: #"HomeHeroTrailSymbol(systemImage: "questionmark.bubble.fill", isPrimary: false)"#))
        XCTAssertNotNil(home.range(of: #"HomeHeroTrailSymbol(systemImage: "doc.on.doc.fill", isPrimary: false)"#))
        ...
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 2, title: "Answer what you know", detail: "Skip anything you're unsure about.", systemImage: "questionmark.bubble.fill")"#))
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 3, title: "Copy the listing", detail: "Price, place, and post are ready.", systemImage: "doc.on.doc.fill")"#))
        ...
        XCTAssertNotNil(home.range(of: #"Copy a listing and it will appear here."#))
    ...
    func testTutorialGraphicEchoesHomeHeroVisualLanguage() throws {
        ...
        XCTAssertNotNil(graphicSource.range(of: #"Image(systemName: "camera.fill")"#))
        XCTAssertNotNil(graphicSource.range(of: #".brandSymbol(.heroIcon)"#))
        XCTAssertNotNil(graphicSource.range(of: #"Image(systemName: "questionmark.bubble.fill")"#))
        XCTAssertNotNil(graphicSource.range(of: #"Image(systemName: "doc.on.doc.fill")"#))
        XCTAssertNotNil(graphicSource.range(of: #"Image(systemName: "tag.fill")"#))
        XCTAssertNotNil(graphicSource.range(of: #"Image(systemName: "checkmark.circle.fill")"#))
    ...
    func testListingExposesNativeCopyButtonsForUsefulDraftFields() throws {
        ...
        XCTAssertNotNil(copyFieldSource.range(of: #"Label("Copy".localized, systemImage: "doc.on.doc.fill")"#))
    ...
    func testListingStructuredDraftGuidanceUsesNativeTipRows() throws {
        let listing = try String(contentsOf: projectURL("BuySellAI/Features/Listing/ListingSheet.swift"), encoding: .utf8)
        let photosRange = try XCTUnwrap(listing.range(of: #"Section("Photos to take".localized) {"#))
        ...
        XCTAssertNotNil(photosSource.range(of: #"title: "First photo""#))
        XCTAssertNotNil(photosSource.range(of: #"systemImage: "camera.fill""#))
        ...
        XCTAssertNotNil(photosSource.range(of: #"systemImage: "plus.viewfinder""#))
        ...
        XCTAssertNotNil(quickTipsSource.range(of: #"systemImage: "shippingbox.fill""#))
