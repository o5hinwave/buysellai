...
final class DesignAccessibilityTests: XCTestCase {
    ...
    func testFeedbackGeneratedContentAndSmallPickerSurfacesUseSharedNativeMaterialChrome() throws {
        ...
        XCTAssertNotNil(home.range(of: #"Label("No listings yet".localized, systemImage: "clock.arrow.circlepath")"#))
    ...
    func testHomePrimaryActionUsesAppleSimpleOneTwoThreeFrontDoor() throws {
        ...
        XCTAssertNotNil(home.range(of: #"HomeHeroTrailSymbol(systemImage: "checklist", isPrimary: false)"#))
        XCTAssertNotNil(home.range(of: #"HomeHeroTrailSymbol(systemImage: "tag.fill", isPrimary: false)"#))
        ...
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 2, title: "Answer what you know", detail: "Skip anything you're unsure about.", systemImage: "checklist")"#))
        XCTAssertNotNil(home.range(of: #"HomeStepRow(number: 3, title: "Copy the listing", detail: "Price, place, and post are ready.", systemImage: "tag.fill")"#))
