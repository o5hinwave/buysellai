...
final class BackendFunctionSourceTests: XCTestCase {
    ...
    func testGenerateListingFunctionPreservesNativeListingContract() throws {
        ...
        XCTAssertNotNil(source.range(of: "Use Google Search only for the minimal research plan provided"))
        ...
        XCTAssertNotNil(source.range(of: "The JSON object must include a string field named listing"))
        XCTAssertNotNil(source.range(of: "Do not return TITLE or DESCRIPTION as top-level JSON keys"))
