...
final class BackendFunctionSourceTests: XCTestCase {
    ...
    func testBackendHealthFunctionExposesOnlyNonSensitiveEarlyAccessState() throws {
        ...
        XCTAssertNotNil(health.range(of: "usageMonitoring"))
        XCTAssertNotNil(health.range(of: "usageMonitoringWindowHours = 24"))
        XCTAssertNotNil(health.range(of: "dailyEventLimit: 200"))
        XCTAssertNotNil(health.range(of: "dailyEstimatedAiCostCentsLimit: 500"))
        XCTAssertNotNil(health.range(of: "dailyGroundedSearchLimit: 250"))
        XCTAssertNotNil(health.range(of: "sampleLimit: 1_000"))
        XCTAssertNotNil(health.range(of: "usage_action,estimated_ai_cost_cents,grounded_search_count"))
        XCTAssertNotNil(health.range(of: "estimatedAiCostCents"))
        XCTAssertNotNil(health.range(of: "groundedSearchCount"))
        XCTAssertNotNil(health.range(of: "usage_sample_limit_reached"))
        XCTAssertNil(health.range(of: "select=user_id"))
        XCTAssertNil(health.range(of: "select=device_id"))
        XCTAssertNil(health.range(of: "select=ip_hash"))
    ...
    func testAnalyzeFunctionPreservesNativeAnalyzeContract() throws {
        ...
        XCTAssertNotNil(source.range(of: "resilientAnalyzeJson"))
        XCTAssertNotNil(source.range(of: "isRecoverableAnalyzeProviderError"))
        XCTAssertNotNil(source.range(of: "deterministicAnalyzeFallback"))
        XCTAssertNotNil(source.range(of: #"value: "Identification needs one more clue""#))
        XCTAssertNotNil(source.range(of: #"question: "Can you find a label, tag, stamp, or model number?""#))
        XCTAssertNotNil(source.range(of: "categoryFromEvidenceText"))
        ...
        XCTAssertNotNil(source.range(of: "Any watch reference or movement clue?"))
        XCTAssertNotNil(source.range(of: "Any lens, mount, or shutter clue?"))
        XCTAssertNotNil(source.range(of: "Is there a grade, set, or card number?"))
        XCTAssertNotNil(source.range(of: "Any pressing, region, or serial clue?"))
        XCTAssertNotNil(source.range(of: #""reference number""#))
        XCTAssertNotNil(source.range(of: #""lens mount""#))
        XCTAssertNotNil(source.range(of: #""card number""#))
        XCTAssertNotNil(source.range(of: #""pressing""#))
    ...
    func testGenerateListingFunctionPreservesNativeListingContract() throws {
        ...
        XCTAssertNotNil(source.range(of: "Return pricing fields only when grounded evidence or the provided marketplace comparison supports them."))
        ...
        XCTAssertNotNil(source.range(of: "const listPrice = hasPricedSoldCompEvidence"))
        XCTAssertNotNil(source.range(of: "const likelySalePrice = hasPricedSoldCompEvidence"))
        XCTAssertNotNil(source.range(of: "const takeHomeEstimate = hasPricedSoldCompEvidence"))
        XCTAssertNotNil(source.range(of: "priorComparison?.takeHomeEstimate ?? null"))
        XCTAssertNotNil(source.range(of: "listPrice: null"))
        XCTAssertNotNil(source.range(of: "likelySalePrice: null"))
        XCTAssertNotNil(source.range(of: "takeHomeEstimate: null"))
        XCTAssertNil(source.range(of: "Math.max(item.currentPrice * 0.9, 1)"))
        XCTAssertNil(source.range(of: "Math.max(likelySalePrice * 0.85, 1)"))
