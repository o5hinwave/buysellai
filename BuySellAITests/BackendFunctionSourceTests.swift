...
final class BackendFunctionSourceTests: XCTestCase {
    ...
    func testGenerateListingFunctionPreservesNativeListingContract() throws {
        ...
        XCTAssertNotNil(source.range(of: "formatUsd"))
        XCTAssertNotNil(source.range(of: "List at:"))
        XCTAssertNotNil(source.range(of: "Likely sells for:"))
        XCTAssertNotNil(source.range(of: "Take-home estimate:"))
        XCTAssertNotNil(source.range(of: "Main photo:"))
        XCTAssertNotNil(source.range(of: "Why ${marketplaceDisplayNames[platform]}"))
