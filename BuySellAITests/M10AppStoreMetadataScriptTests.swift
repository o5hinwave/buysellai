...
final class M10AppStoreMetadataScriptTests: XCTestCase {
    func testMetadataVerifierRequiresConcreteAppStoreConnectSubmissionFields() throws {
        ...
        XCTAssertNotNil(script.range(of: "M10_APP_STORE_SCREENSHOT_DIR"))
        XCTAssertNotNil(script.range(of: "M10_APP_STORE_SCREENSHOT_WIDTH:-1206"))
        XCTAssertNotNil(script.range(of: "M10_APP_STORE_SCREENSHOT_HEIGHT:-2622"))
