...
final class M10SubmitReadinessScriptTests: XCTestCase {
    ...
    func testAcceptanceDocsAndReadmeRouteThroughCombinedSubmitReadinessGate() throws {
        ...
        XCTAssertNotNil(readme.range(of: "same `sign in with apple:` entitlement marker"))
        XCTAssertNotNil(readme.range(of: "real-device preflight logs record the same `release build:` value"))
        ...
        XCTAssertNotNil(m10.range(of: "same `sign in with apple:` entitlement marker"))
        XCTAssertNotNil(m10.range(of: "real-device preflight logs record the same `release build:` value"))
        XCTAssertNotNil(m10.range(of: "real-device `device:`, `device name:`, `device id:`, `app:`, and `release build:`"))
