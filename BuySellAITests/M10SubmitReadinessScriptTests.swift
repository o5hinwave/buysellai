...
final class M10SubmitReadinessScriptTests: XCTestCase {
    ...
    func testSubmitReadinessScriptRequiresConcreteLogArtifactMarkers() throws {
        ...
        XCTAssertNotNil(script.range(of: "home setup: pearl Apple Card-style centered camera card, in-card Photo Answer Copy strip, native 1-2-3 task rows, quiet footer copy, restrained warm accent, monochrome toolbar wordmark, account, and settings actions"))
