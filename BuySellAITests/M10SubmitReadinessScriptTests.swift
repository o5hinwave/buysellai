...
final class M10SubmitReadinessScriptTests: XCTestCase {
    ...
    func testAcceptanceDocsAndReadmeRouteThroughCombinedSubmitReadinessGate() throws {
        ...
        XCTAssertNotNil(readme.range(of: "same logs record the same `release build:` value"))
        ...
        XCTAssertNotNil(m10.range(of: "same logs record the same `release build:` value"))
