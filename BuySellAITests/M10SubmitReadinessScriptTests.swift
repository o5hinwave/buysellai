...
final class M10SubmitReadinessScriptTests: XCTestCase {
    ...
    func testAcceptanceDocsAndReadmeRouteThroughCombinedSubmitReadinessGate() throws {
        ...
        XCTAssertNotNil(readme.range(of: "same `release build:` value"))
        ...
        XCTAssertNotNil(m10.range(of: "same `release build:` value"))
        XCTAssertNotNil(m10.range(of: "real-device `device:`, `device name:`, and `device id:`"))
