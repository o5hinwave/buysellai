...
final class M10SubmitReadinessScriptTests: XCTestCase {
    func testSubmitReadinessScriptAggregatesAllM10EvidenceGates() throws {
        ...
        XCTAssertNotNil(script.range(of: "M10_MIN_UNIT_TESTS:-473"))
    ...
    func testSubmitReadinessScriptRequiresConcreteLogArtifactMarkers() throws {
        ...
        XCTAssertNotNil(script.range(of: "home setup: pearl Apple Card-style centered camera card, always-visible recent listings empty state, native icon trail, circular listing loop badge, native 1-2-3 task rows, quiet footer copy, restrained warm accent, monochrome toolbar wordmark, account, and settings actions"))
        ...
        XCTAssertNotNil(script.range(of: "constraints: history category condition marketplace listing apple-token-identity marketplace-research-cache early-access-entitlements usage-protection"))
        ...
        XCTAssertNotNil(script.range(of: "early access: server-controlled entitlements with usage protection"))
        ...
        XCTAssertNotNil(script.range(of: "iphone 6.9 screenshot result bundle: /tmp/buysell-m10-screenshots-iphone-16-pro-max-apple-card-20260723.xcresult"))
        XCTAssertNotNil(script.range(of: "ipad 13 screenshot result bundle: /tmp/buysell-m10-screenshots-ipad-pro-13-apple-card-20260723.xcresult"))
    ...
    func testAcceptanceDocsAndReadmeRouteThroughCombinedSubmitReadinessGate() throws {
        ...
        XCTAssertNotNil(readme.range(of: "no-sign archive log retains the `app icon:`, `system design:`, `custom fonts:`, and `release fixtures:` markers"))
        ...
        XCTAssertNotNil(readme.range(of: "obsolete primary, secondary, and ghost pill helpers plus their primary/standard background modifiers remain removed"))
        XCTAssertNotNil(readme.range(of: "active controls use iOS 26+ standard glass or restrained system/material fallbacks"))
        XCTAssertNil(readme.range(of: "primary CTAs use iOS 26+ prominent glass with an orange tint"))
        XCTAssertNil(readme.range(of: "orange capsule as the older-SDK fallback"))
        ...
        XCTAssertNotNil(readme.range(of: "listing research cache: Gemini grounding saved"))
        XCTAssertNotNil(m10.range(of: "pass logs retain their concrete artifact markers"))
        XCTAssertNotNil(m10.range(of: "no-sign `archive:`, `bundle id:`, `release build:`, `app icon:`, `system design:`, `custom fonts:`, `release fixtures:`, and `app size:`"))
        XCTAssertNotNil(m10.range(of: "latest design `M10 latest design SDK passed`, `xcode:`, `iphoneos sdk:`, `liquid glass sdk:`, `source:`, `source liquid glass:`, `obsolete button primitives:`, `active control glass:`, `home setup:`, `camera setup:`, `auth setup:`, `tutorial setup:`, `menu item icons:`, and `system sheet background:`"))
        XCTAssertNotNil(m10.range(of: "obsolete primary, secondary, and ghost pill helpers plus their primary/standard background modifiers remain removed"))
        XCTAssertNotNil(m10.range(of: "active controls use iOS 26+ standard glass or restrained system/material fallbacks"))
        XCTAssertNil(m10.range(of: "primary CTAs use iOS 26+ prominent glass with an orange tint"))
        XCTAssertNil(m10.range(of: "orange capsule as the older-SDK fallback"))
        XCTAssertNotNil(m10.range(of: "unit test suite result bundle"))
        XCTAssertNotNil(m10.range(of: "local source typecheck `BuySellAI local source typecheck passed`, `target:`, `sdk:`, `sources:`, and `modes:`"))
        XCTAssertNotNil(m10.range(of: "M10_SOURCE_TYPECHECK_LOG"))
        XCTAssertNotNil(m10.range(of: "listing research cache: Gemini grounding saved"))
        ...
        XCTAssertNotNil(m10.range(of: "Supabase function type-check `Supabase function Deno check passed`, `functions:`, `listing research cache: Gemini grounding saved`, and `listing draft: structured fields formatted deterministically`"))
