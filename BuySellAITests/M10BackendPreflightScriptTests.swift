...
final class M10BackendPreflightScriptTests: XCTestCase {
    ...
    func testSupabaseSchemaStaticCheckScriptCoversRLSGrantsIndexesAndSwiftParity() throws {
        ...
        [
            ...
            "20260726134945_align_early_access_entitlement_defaults.sql",
            ...
            "constraints: history category condition marketplace listing metadata identification-profile marketplace-comparison supplemental-photos apple-token-identity marketplace-research-cache early-access-entitlements usage-protection",
    ...
    func testSupabaseDeployHelperGuardsRemoteSchemaAndFunctionDeployment() throws {
        ...
        XCTAssertNotNil(script.range(of: "supabase/migrations/20260726134945_align_early_access_entitlement_defaults.sql"))
        ...
        XCTAssertNotNil(script.range(of: "M10 Supabase functions deploy passed"))
