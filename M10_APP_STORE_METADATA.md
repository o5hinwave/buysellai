...
| Result | Passed as part of the retained full simulator suite `/tmp/buysell-submit-readiness-full.xcresult` with 336 tests and 0 failures on 2026-07-16; standalone screenshot bundle `/tmp/buysell-m10-screenshots.xcresult` is also retained. |
