...
- The active app typography uses San Francisco system Dynamic Type roles through `BrandTextStyle`; bundled legacy font files remain source assets only and are not registered through `UIAppFonts`.
