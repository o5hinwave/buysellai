...
tests=(
    ...
    "BuySellAIUITests/BuySellAIUITests/testTutorialNextWalksThroughAllSlidesAndGetStartedDismisses"
    "BuySellAIUITests/BuySellAIUITests/testTutorialSwipeGesturesNavigateBetweenSlides"
