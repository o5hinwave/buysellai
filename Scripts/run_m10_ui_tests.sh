...
tests=(
    ...
    "BuySellAIUITests/BuySellAIUITests/testFiveSlideTutorialNextGetStartedDismisses"
    "BuySellAIUITests/BuySellAIUITests/testFiveSlideTutorialSupportsSwipePaging"
