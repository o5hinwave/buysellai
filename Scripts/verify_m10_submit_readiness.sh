...
require_file_contains "$supabase_deploy_log" "constraints: history category condition marketplace listing metadata identification-profile marketplace-comparison apple-token-identity marketplace-research-cache early-access-entitlements usage-protection" "Supabase deploy log"
...
require_file_contains "$supabase_schema_log" "constraints: history category condition marketplace listing metadata identification-profile marketplace-comparison apple-token-identity marketplace-research-cache early-access-entitlements usage-protection" "Supabase schema static check log"
