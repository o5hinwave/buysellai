...
require_file_contains "$backend_log" "functions: analyze-image compare-marketplaces generate-listing store-apple-token delete-account" "backend preflight log"
...
require_file_contains "$supabase_deploy_log" "functions: analyze-image compare-marketplaces generate-listing store-apple-token delete-account" "Supabase deploy log"
...
require_file_contains "$supabase_function_log" "functions: analyze-image compare-marketplaces generate-listing store-apple-token delete-account" "Supabase function type-check log"
