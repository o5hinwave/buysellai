...
require_file_contains "$backend_log" "schema: history apple_auth_tokens marketplace_research_cache" "backend preflight log"
...
require_file_contains "$backend_log" "protected tables: history apple_auth_tokens marketplace_research_cache" "backend preflight log"
...
require_file_contains "$supabase_deploy_log" "schema: history apple_auth_tokens marketplace_research_cache" "Supabase deploy log"
require_file_contains "$supabase_deploy_log" "constraints: history category condition marketplace listing apple-token-identity marketplace-research-cache" "Supabase deploy log"
...
require_file_contains "$supabase_schema_log" "tables: history apple_auth_tokens marketplace_research_cache" "Supabase schema static check log"
require_file_contains "$supabase_schema_log" "rls: history apple_auth_tokens marketplace_research_cache forced" "Supabase schema static check log"
...
require_file_contains "$supabase_schema_log" "grants: history authenticated service_role apple_auth_tokens service_role marketplace_research_cache service_role" "Supabase schema static check log"
require_file_contains "$supabase_schema_log" "constraints: history category condition marketplace listing apple-token-identity marketplace-research-cache" "Supabase schema static check log"
