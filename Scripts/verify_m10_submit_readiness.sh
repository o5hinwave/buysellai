...
require_file_contains "$latest_design_log" "home setup: pearl Apple Card-style centered camera card, in-card Photo Answer Copy strip, native 1-2-3 task rows, quiet footer copy, restrained warm accent, monochrome toolbar wordmark, account, and settings actions" "latest design SDK evidence log"
